...
_RELATION_TYPES: Dict[str, Dict[str, str]] = {
    ...
    "CAUSED_BY": {ZH: "可能原因", EN: "caused by"},
    "DIAGNOSED_BY": {ZH: "诊断手段", EN: "diagnosed by"},
    "RESOLVED_BY": {ZH: "解决方案", EN: "resolved by"},
    "MITIGATED_BY": {ZH: "缓解措施", EN: "mitigated by"},
    "VERIFIED_BY": {ZH: "验证手段", EN: "verified by"},
    "INDICATES": {ZH: "指示", EN: "indicates"},
